...
if (jQuery(window).width() >= 1280 ) {
	...
	jQuery("header .banner .left .left-inner a").mouseenter(function(){
	  jQuery('header .banner .left .left-inner a .gradient-overlay').addClass("animated");        
	})
	
	jQuery("header .banner .left .left-inner a .gradient-overlay").bind("webkitAnimationEnd mozAnimationEnd animationend", function(){
	...
	jQuery(".gradient-hover").bind("webkitAnimationEnd mozAnimationEnd animationend", function(){
	  jQuery(this).removeClass("animated")  
	})
	...
	jQuery(".gform_footer").bind("webkitAnimationEnd mozAnimationEnd animationend", function(){
	  jQuery(this).removeClass("animated")  
	})
	...
	jQuery(".post .read-more").bind("webkitAnimationEnd mozAnimationEnd animationend", function(){
	  jQuery(this).removeClass("animated")  
	})
...
jQuery('.close').click(function(){
	...
	jQuery('header .top-bar #main-menu-overlay .main-menu .primary-menu').removeClass('hide-primary');
	jQuery('header .top-bar #main-menu-overlay .main-menu span').removeClass('show');
});
...
jQuery('#menu-main-menu .menu-item-has-children').click(function(){
	...
	jQuery(this).children('.sub-menu').clone().appendTo('.secondary-menu').delay(0).queue(function() {
    jQuery(this).addClass("active-secondary-menu").dequeue();
  });
  jQuery('header .top-bar #main-menu-overlay .main-menu .primary-menu').addClass('hide-primary');
  jQuery('header .top-bar #main-menu-overlay .main-menu span').addClass('show');
});

jQuery('header .top-bar #main-menu-overlay .main-menu span').click(function(){
	jQuery(this).removeClass('show');
	jQuery('header .top-bar #main-menu-overlay .main-menu .primary-menu').removeClass('hide-primary');
	jQuery('html.menu-open #main-menu-overlay .main-menu .secondary-menu .sub-menu').removeClass('active-secondary-menu');
});
	
/* Gravity Forms
-------------------------------------------------------------- */

jQuery(".gform_wrapper").append("<p class='fields-required'>Required fields</p>");
...
-------------------------------------------------------------- */
	...
	if (jQuery(window).width() >= 1280 ) {
		...
		jQuery(function() {
		    ...
		    var parallax = new TweenMax.from('#section-3 .section-3-inner .accent-box', 1, {
		        y: '200px'
		    });
		...
		jQuery(function() {
		    ...
		    var parallax = new TweenMax.from('#section-5 .section-5-inner .content-wrap .accent-box', 1, {
		        y: '200px'
		    });
...
-------------------------------------------------------------- */
	...
	jQuery(".smooth-scroll").click(function(event) {
	  ...
	  jQuery('html,body').animate( { scrollTop:jQuery(this.hash).offset().top - 100} , 2000);
	});
